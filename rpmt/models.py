...
class Project(db.Model):
    ...
    publication_name = db.Column(db.String(200), nullable=False)
    publisher = db.Column(db.String(200), nullable=False)
    publisher_type = db.Column(db.String(100), nullable=False)
    publisher_location = db.Column(db.String(50), nullable=False)
    editors = db.relationship('EditorProject', backref='project', lazy=True, cascade="all, delete")
    vol_issue_no = db.Column(db.String(50), nullable=False)
    doi_url = db.Column(db.String(300), unique=True, nullable=False)
    ...
    other_database = db.Column(db.String(200), nullable=False)
    citations = db.Column(db.Integer, nullable=False)
    publication_proof = db.Column(db.String(300), nullable=False)
    utilization_proof = db.Column(db.String(300), nullable=False)
    pdf = db.Column(db.String(300), nullable=False)
