...
class Project(db.Model):
    ...
    publication_proof = db.Column(db.String(256), nullable=False)
    utilization_proof = db.Column(db.String(256), nullable=False)
    pdf = db.Column(db.String(256), nullable=False)
